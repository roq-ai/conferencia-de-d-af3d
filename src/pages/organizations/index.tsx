...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'access_request.count', 'document.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('access_request', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'access_request',
          header: 'Access Request',
          accessorKey: 'access_request',
          cell: ({ row: { original: record } }: any) => record?._count?.access_request,
        }
      : null,
