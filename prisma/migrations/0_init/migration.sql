...
-- AddForeignKey
ALTER TABLE "access_request" ADD CONSTRAINT "access_request_guest_user_id_fkey" FOREIGN KEY ("guest_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
